...
search_client = SerpAPIWrapper(serpapi_api_key=os.getenv("SERPAPI_KEY"))
...
def update_patient_record(patient_id: str, field: str, value: str) -> str:
    ...
    Examples: field='medications', value='Aspirin 81mg' or field='conditions', value='Hypertension'.
    ...
    _save_patient_db()  # persists if USE_JSON_DB=True, no-op otherwise
...
def search_medical_info(query: str) -> str:
    """Search for up-to-date medical information, treatment guidelines, and disease info
    from trusted health sources like WHO, Mayo Clinic, CDC, and Medline."""
