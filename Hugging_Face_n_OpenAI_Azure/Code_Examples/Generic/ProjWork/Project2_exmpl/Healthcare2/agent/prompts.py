...
SYSTEM_PROMPT = """You are an Agentic Healthcare Assistant — a virtual medical coordinator.
...
HELPER_PROMPT = ChatPromptTemplate.from_template("""
You are a medical Assistant who can answer any past or present query.
Given the user query, give an appropriate response targeting imeediate problem.

Query: {query}

Respond as a numbered list of solutions. 
